...
async def summarize_eligibility(html_content: str) -> str:
    ...
    system_prompt = (
        ...
        "eligibility requirement and every award criterion, whether formal, financial, technical, "
        "experience levels, etc., then produce a concise summary – it should be no longer than "
        "1,000 characters, and categorize the eligibility criteria (e.g., Financial, Technical, "
        "Formal etc.) that bidders must fulfil."
    )
    messages = [
